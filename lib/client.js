...
function ProgressTimeline({ progress, onHistory, onRefresh }) {
...
var EMPTY_SESSION_SNAPSHOT = Object.freeze({ running: false, queue: [], runningCalls: [] });
...
function FrontendFeedbackPanel({
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const unfinished = history.filter((record) => record.status === "queued" || record.status === "running").sort((a, b) => a.createdAt - b.createdAt);
    ...
    if (agentRunning && runningCandidate !== void 0) {
      activeBatchIdRef.current = runningCandidate.id;
      if (runningCandidate.status === "queued") {
        reconcileBusyRef.current = true;
        void historyStore.put(transitionBatch(runningCandidate, "running")).then(refreshHistory).finally(() => {
    ...
    if (!agentRunning && staleRunning !== void 0) {
      reconcileBusyRef.current = true;
      pendingAfterBatchIdRef.current = staleRunning.id;
      void historyStore.put(transitionBatch(staleRunning, "capturing-after")).then(refreshHistory).then(() => refreshPreview("\u6B63\u5728\u6062\u590D\u672A\u7ED3\u7B97\u7684 PageCraft \u6279\u6B21\u2026", "Agent \u5DF2\u7ED3\u675F\uFF0C\u6B63\u5728\u6355\u83B7\u4FEE\u6539\u540E\u9875\u9762\u3002")).finally(() => {
        reconcileBusyRef.current = false;
      });
    }
