...
// src/client/guidance.tsx
var import_react4 = require("react");

// src/guidance.ts
function clean(value, max = 54) {
...
function scopeText(scope, viewport) {
  const point = `${viewport.label ?? viewport.id}\uFF08${viewport.width}\xD7${viewport.height}\uFF09`;
  if (scope === "current-breakpoint") return `\u4EC5\u4F5C\u7528\u4E8E\u5F53\u524D ${point} \u65AD\u70B9`;
  if (scope === "current-and-smaller") return `\u4F5C\u7528\u4E8E ${point} \u53CA\u66F4\u5C0F\u65AD\u70B9`;
  return "\u9002\u914D\u5168\u90E8\u54CD\u5E94\u5F0F\u65AD\u70B9";
}
function targetText(selection) {
  if (selection.kind === "area") return `\u6846\u9009\u533A\u57DF ${selection.rect.width}\xD7${selection.rect.height}px`;
  return clean(selection.text) || clean(selection.selector) || selection.tagName.toUpperCase();
}
function draftPrefix(selection) {
...
function buildGuidanceSuggestions(selection, context) {
  ...
  const operation = context.areaOperation === "overlay" ? "\u4EE5\u8986\u76D6\u5C42\u65B9\u5F0F\u5448\u73B0\uFF0C\u4E0D\u63A8\u5F00\u73B0\u6709\u5185\u5BB9" : context.areaOperation === "replace" ? "\u66FF\u6362\u6846\u5185\u73B0\u6709\u5185\u5BB9\u5E76\u4FDD\u6301\u5468\u56F4\u5E03\u5C40\u7A33\u5B9A" : "\u4F7F\u7528\u6B63\u5E38\u6587\u6863\u6D41\u63D2\u5165\uFF0C\u5E76\u81EA\u7136\u63A8\u5F00\u540E\u7EED\u5185\u5BB9";
  const suggestions = {
    action: [
...
function applyGuidanceDraft(current, draft) {
  const existing = current.trim();
  if (existing.length === 0) return draft;
  return `${existing}${/[。！？.!?]$/.test(existing) ? "" : "\uFF1B"}${draft}`;
}
function toggleConstraint(current, constraint) {
...
function GuidanceEditor({ selection, context, value, onChange, onQueue }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.editor, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.intro, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { style: styles4.title, children: model.title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { style: styles4.target, children: [
          "\u5F53\u524D\u76EE\u6807\uFF1A",
          model.target
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: styles4.tip, children: "\u70B9\u51FB\u5EFA\u8BAE\u4F1A\u751F\u6210\u8349\u7A3F\uFF0C\u4F60\u4ECD\u53EF\u81EA\u7531\u4FEE\u6539" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { role: "group", "aria-label": "\u5FEB\u6377\u4FEE\u6539\u5EFA\u8BAE", style: styles4.suggestions, children: model.suggestions.map((suggestion) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "button",
      {
        type: "button",
        onClick: () => onChange(applyGuidanceDraft(value, suggestion.draft)),
        title: suggestion.description,
        style: styles4.suggestion,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: suggestion.label }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: suggestion.description })
        ]
      },
      suggestion.id
    )) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: styles4.constraintRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: styles4.constraintLabel, children: "\u5E38\u7528\u7EA6\u675F" }),
      model.constraints.map((constraint) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        "button",
        {
          type: "button",
          "aria-pressed": value.includes(constraint),
          onClick: () => onChange(toggleConstraint(value, constraint)),
          style: { ...styles4.constraint, ...value.includes(constraint) ? styles4.constraintActive : {} },
          children: [
            "+ ",
            constraint
          ]
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: styles4.keyboard, children: "Ctrl / \u2318 + Enter \u52A0\u5165\u961F\u5217\uFF1B\u8349\u7A3F\u4E0D\u4F1A\u81EA\u52A8\u53D1\u9001" })
  ] });
}
var styles4 = {
...
function classifyRunningCalls(calls) {
  ...
  const detail = shortArgs.length > 0 ? `${name} \xB7 ${shortArgs}` : `\u6B63\u5728\u6267\u884C ${name}`;
...
function visualOutcome(record) {
  if (record.before?.dataUrl === void 0 || record.after?.dataUrl === void 0) return "unverified";
...
function deriveBatchProgress(record, snapshot = {}, records = [record], now = Date.now()) {
  ...
  if (error !== void 0 && record.status === "failed") {
    ...
    detail = outcome === "changed" ? "\u68C0\u6D4B\u5230\u9875\u9762\u89C6\u89C9\u53D8\u5316\uFF0C\u53EF\u67E5\u770B\u4FEE\u6539\u524D\u540E\u5BF9\u6BD4" : outcome === "unchanged" ? "\u672A\u68C0\u6D4B\u5230\u89C6\u89C9\u53D8\u5316\uFF0C\u53EF\u80FD\u662F\u975E\u89C6\u89C9\u4FEE\u6539\u6216\u76EE\u6807\u6587\u4EF6\u672A\u66F4\u65B0" : "\u4EFB\u52A1\u5DF2\u7ED3\u675F\uFF0C\u4F46\u7F3A\u5C11\u5B8C\u6574\u622A\u56FE\uFF0C\u65E0\u6CD5\u9A8C\u8BC1\u89C6\u89C9\u53D8\u5316";
    ...
    const unfinished = records.filter((item) => ["queued", "running"].includes(item.status)).sort((a, b) => a.createdAt - b.createdAt);
...
function progressStepState(step, current) {
...
function outcomeLabel(progress) {
...
function ProgressTimeline({ progress, onHistory, onRefresh, onReconcile }) {
  const [collapsed, setCollapsed] = (0, import_react5.useState)(false);
  const terminal = progress.stage === "completed" || progress.stage === "failed";
  const longRunning = !terminal && progress.elapsedMs >= 6e4;
  const timelineStage = progress.stage === "thinking" ? "queued" : progress.stage === "checkpointing" ? "locating" : progress.stage === "finalizing" ? "verifying" : progress.stage;
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { "aria-label": "PageCraft \u4EFB\u52A1\u8FDB\u5EA6", style: styles5.panel, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("style", { children: `@keyframes pagecraftPulse{0%,100%{opacity:.55;transform:scale(.88)}50%{opacity:1;transform:scale(1)}}@media(prefers-reduced-motion:reduce){[data-pagecraft-progress-pulse]{animation:none!important}}` }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("header", { style: styles5.header, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: styles5.heading, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { "data-pagecraft-progress-pulse": "", style: { ...styles5.pulse, ...terminal ? styles5.pulseDone : {} }, "aria-hidden": "true" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { style: styles5.title, children: progress.label }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: styles5.meta, children: [
            "#",
            progress.batchId.slice(0, 8),
            " \xB7 ",
            progress.annotationCount,
            " \u6761\u8BC4\u6CE8 \xB7 ",
            formatElapsed(progress.elapsedMs)
          ] })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: () => setCollapsed((value) => !value), style: styles5.collapse, children: collapsed ? "\u5C55\u5F00" : "\u6536\u8D77" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { "aria-live": "polite", style: styles5.currentAction, children: progress.detail }),
    collapsed ? null : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("ol", { style: styles5.timeline, children: STEPS.map((step, index) => {
        const state = progressStepState(step.stage, timelineStage);
        return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("li", { "aria-current": state === "current" ? "step" : void 0, style: styles5.step, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: {
            ...styles5.node,
            ...state === "done" ? styles5.nodeDone : {},
            ...state === "current" ? styles5.nodeCurrent : {}
          }, children: state === "done" ? "\u2713" : index + 1 }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { ...styles5.stepLabel, ...state === "upcoming" ? styles5.stepUpcoming : {} }, children: step.label })
        ] }, step.stage);
      }) }),
      progress.queueAhead > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: styles5.notice, children: [
        "\u524D\u9762\u8FD8\u6709 ",
        progress.queueAhead,
        " \u4E2A DSH \u4EFB\u52A1\uFF0CPageCraft \u4F1A\u81EA\u52A8\u7EE7\u7EED\u8DDF\u8E2A\u3002"
      ] }) : null,
      longRunning ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: styles5.notice, children: "\u4EFB\u52A1\u4ECD\u5728\u8FD0\u884C\u3002\u4F60\u53EF\u4EE5\u5173\u95ED PageCraft \u7EE7\u7EED\u5DE5\u4F5C\uFF0C\u91CD\u65B0\u6253\u5F00\u540E\u4F1A\u6062\u590D\u8FDB\u5EA6\u3002" }) : null,
      outcomeLabel(progress) !== null ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: styles5.outcome, children: outcomeLabel(progress) }) : null,
      progress.stage === "failed" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { role: "alert", style: styles5.error, children: progress.error ?? progress.detail }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: styles5.actions, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: onHistory, style: styles5.secondary, children: "\u67E5\u770B\u6BD4\u8F83\u4E0E\u5386\u53F2" }),
        !terminal ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: onReconcile, style: styles5.secondary, children: "\u91CD\u65B0\u68C0\u6D4B" }) : null,
        terminal ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", onClick: onRefresh, style: styles5.primary, children: "\u5237\u65B0\u9884\u89C8" }) : null
      ] })
    ] })
  ] });
}
...
function contentText(node) {
  const content = (node.content ?? []).filter((block) => block.type === "text" || typeof block.text === "string").map((block) => block.text ?? "");
  const blocks = (node.blocks ?? []).filter((block) => block.kind === "text" || typeof block.text === "string").map((block) => block.text ?? "");
  return [...content, ...blocks].join("\n");
}
function queueContains(batchId, queue) {
  return queue.some((item) => `${item.preview ?? ""}
${item.text ?? ""}`.includes(batchId));
}
function requestNodeFor(batchId, nodes) {
  return nodes.filter((node) => (node.kind === "user" || node.kind === "steering") && contentText(node).includes(batchId)).sort((a, b) => (b.seq ?? -1) - (a.seq ?? -1))[0];
}
function nextInputSeq(after, nodes) {
  return nodes.filter((node) => (node.kind === "user" || node.kind === "steering") && typeof node.seq === "number" && node.seq > after).map((node) => node.seq).sort((a, b) => a - b)[0];
}
function completionFor(record, request, snapshot, claimedTurns) {
  const requestSeq = request.seq;
  if (requestSeq === void 0) return { kind: "waiting", reason: "completion-unmatched" };
  const boundary = nextInputSeq(requestSeq, snapshot.nodes ?? []);
  const baseline = record.baselineCompletedTurn ?? -1;
  const candidates = [...(snapshot.turnEnds ?? /* @__PURE__ */ new Map()).entries()].filter(([turn, endSeq]) => turn > baseline && endSeq > requestSeq && (boundary === void 0 || endSeq < boundary)).sort((a, b) => a[1] - b[1]);
  for (const [turn] of candidates) {
    ...
    const assistant = (snapshot.nodes ?? []).find(
      (node) => node.kind === "assistant" && node.turn === turn && node.interrupted !== true && (node.seq ?? -1) > requestSeq
    );
    if (assistant !== void 0) return { kind: "completed", turn };
  }
  return { kind: "waiting", reason: candidates.length > 0 ? "completion-unmatched" : "turn-open" };
}
function maxCompletedTurn(snapshot) {
  const turns = [...(snapshot.turnEnds ?? /* @__PURE__ */ new Map()).keys()];
  return turns.length === 0 ? void 0 : Math.max(...turns);
}
function reconcilePageCraftBatches(records, snapshot) {
  const unfinished = records.filter((record) => record.status === "queued" || record.status === "running").sort((a, b) => a.createdAt - b.createdAt);
  const nodes = snapshot.nodes ?? [];
  const queue = snapshot.queue ?? [];
  const claimedTurns = new Set(records.flatMap((record) => record.settledTurn === void 0 ? [] : [record.settledTurn]));
  ...
  return unfinished.map((record) => {
    ...
    if (snapshot.running === true && !runningAssigned && (request !== void 0 || record === unfinished[0])) {
...
var EMPTY_SESSION_SNAPSHOT = Object.freeze({
  running: false,
  queue: [],
  runningCalls: [],
  nodes: [],
...
function useSessionSnapshot(activity) {
  const subscribe = (0, import_react6.useCallback)((listener) => activity?.subscribe(listener) ?? (() => {
  }), [activity]);
  const getSnapshot = (0, import_react6.useCallback)(() => activity?.getSnapshot() ?? EMPTY_SESSION_SNAPSHOT, [activity]);
  return (0, import_react6.useSyncExternalStore)(subscribe, getSnapshot, () => EMPTY_SESSION_SNAPSHOT);
}
var AREA_OPERATIONS = [
...
function FrontendFeedbackPanel({
  ...
  const captureResolversRef = (0, import_react6.useRef)(/* @__PURE__ */ new Map());
  const activeBatchIdRef = (0, import_react6.useRef)(null);
  const pendingAfterBatchIdRef = (0, import_react6.useRef)(null);
  const activeRollbackBatchIdRef = (0, import_react6.useRef)(null);
  const pendingRollbackBatchIdRef = (0, import_react6.useRef)(null);
  const reconcileBusyRef = (0, import_react6.useRef)(false);
  const historyStore = (0, import_react6.useMemo)(() => new VisualHistoryStore(), []);
  ...
  const [selection, setSelection] = (0, import_react6.useState)(initialDraft.selection);
  const [areaOperation, setAreaOperation] = (0, import_react6.useState)(initialDraft.areaOperation);
  const [comment, setComment] = (0, import_react6.useState)(initialDraft.comment);
  ...
  const [viewport, setViewport] = (0, import_react6.useState)(VIEWPORT_PRESETS[0]);
  const [responsiveScope, setResponsiveScope] = (0, import_react6.useState)("current-breakpoint");
  const [captureBusy, setCaptureBusy] = (0, import_react6.useState)(false);
  const [lastScreenshot, setLastScreenshot] = (0, import_react6.useState)(void 0);
  const [history, setHistory] = (0, import_react6.useState)([]);
  const [selectedHistoryId, setSelectedHistoryId] = (0, import_react6.useState)(null);
  const [showHistory, setShowHistory] = (0, import_react6.useState)(false);
  const [showStudio, setShowStudio] = (0, import_react6.useState)(false);
  const [studioBusy, setStudioBusy] = (0, import_react6.useState)(false);
  const [rollbackBusy, setRollbackBusy] = (0, import_react6.useState)(false);
  const [clock, setClock] = (0, import_react6.useState)(Date.now());
  const [reconcileNonce, setReconcileNonce] = (0, import_react6.useState)(0);
  const loadedUrl = currentPreviewUrl(navigation);
  const canGoBack = navigation.index > 0;
  const canGoForward = navigation.index < navigation.entries.length - 1;
  const progressRecords = (0, import_react6.useMemo)(() => history.filter((record) => ["capturing-before", "queued", "running", "capturing-after", "failed", "completed"].includes(record.status)).sort((a, b) => a.createdAt - b.createdAt), [history]);
  const activeProgressRecord = progressRecords.find((record) => !["completed", "failed"].includes(record.status)) ?? progressRecords[progressRecords.length - 1];
  const activeProgress = activeProgressRecord === void 0 ? null : deriveBatchProgress(activeProgressRecord, sessionSnapshot, progressRecords, clock);
  ...
  const refreshHistory = (0, import_react6.useCallback)(async () => {
  ...
  const postResponsiveContext = (0, import_react6.useCallback)(() => {
  ...
  const requestCapture = (0, import_react6.useCallback)((kind) => {
  ...
  const captureForStage = (0, import_react6.useCallback)(async (stage) => {
  ...
  const captureNow = (0, import_react6.useCallback)(async () => {
    setCaptureBusy(true);
    try {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    const actionable = reconciliations.find(({ batchId, decision }) => {
      const record2 = history.find((item) => item.id === batchId);
      if (record2 === void 0) return false;
      if (decision.kind === "running") return record2.status === "queued" || record2.observedRunning !== true;
      return decision.kind === "completed" || decision.kind === "failed";
    });
    if (actionable === void 0) return;
    ...
    if (actionable.decision.kind === "running") {
      ...
      void historyStore.put(running).then(refreshHistory).finally(() => {
    ...
    if (actionable.decision.kind === "failed") {
      ...
      void historyStore.put(failed).then(refreshHistory).then(() => setStatus(`Agent \u4FEE\u6539\u5931\u8D25\uFF1A${error}`)).finally(() => {
        reconcileBusyRef.current = false;
      });
      return;
    }
    ...
    void historyStore.put(capturing).then(refreshHistory).then(() => refreshPreview("\u68C0\u6D4B\u5230 Agent \u5DF2\u5B8C\u6210\uFF0C\u6B63\u5728\u540C\u6B65\u6700\u65B0\u9875\u9762\u2026", "Agent \u4FEE\u6539\u5B8C\u6210\uFF0C\u6B63\u5728\u6355\u83B7\u4FEE\u6539\u540E\u9875\u9762\u3002")).finally(() => {
      reconcileBusyRef.current = false;
    });
  ...
  (0, import_react6.useEffect)(() => {
    const listener = (event) => {
      ...
      setComment("");
      setStatus(event.data.payload.kind === "area" ? `\u5DF2\u6846\u9009 ${event.data.payload.rect.width} \xD7 ${event.data.payload.rect.height}px \u533A\u57DF\u3002\u8BF7\u5728\u53F3\u4FA7\u9009\u62E9\u201C\u65B0\u589E\u5185\u5BB9 / \u589E\u52A0\u88C5\u9970 / \u91CD\u65B0\u5E03\u5C40 / \u52A0\u5165\u4EA4\u4E92\u201D\uFF0C\u518D\u8865\u5145\u4F60\u60F3\u770B\u5230\u7684\u7ED3\u679C\u3002` : `\u5DF2\u9009\u62E9 ${event.data.payload.selector}\u3002\u53F3\u4FA7\u5DF2\u6309\u5143\u7D20\u7C7B\u578B\u51C6\u5907\u4FEE\u6539\u5EFA\u8BAE\uFF1B\u70B9\u51FB\u5EFA\u8BAE\u751F\u6210\u8349\u7A3F\u540E\uFF0C\u53EF\u7EE7\u7EED\u7EC6\u5316\u5185\u5BB9\u3001\u89C6\u89C9\u3001\u5E03\u5C40\u548C\u4EA4\u4E92\u8981\u6C42\u3002`);
    };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.root, "data-conversation-composer-overlay": "", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.toolbar, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.brand, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.brandDot }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { style: styles6.title, children: "PageCraft" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.subtitle, children: workspaceMode === "presentation" ? "\u6F14\u793A\u6587\u7A3F \xB7 \u5E7B\u706F\u7247\u8BC4\u6CE8" : "\u7F51\u9875\u9884\u89C8 \xB7 DOM \u4E0E\u533A\u57DF\u8BC4\u6CE8" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { role: "tablist", "aria-label": "PageCraft \u5DE5\u4F5C\u6A21\u5F0F", style: styles6.workspaceModeGroup, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            ...
            style: { ...styles6.workspaceModeButton, ...workspaceMode === "webpage" ? styles6.workspaceModeButtonActive : {} },
            children: "\u7F51\u9875"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            ...
            style: { ...styles6.workspaceModeButton, ...workspaceMode === "presentation" ? styles6.workspaceModeButtonActive : {} },
            children: "\u6F14\u793A\u6587\u7A3F"
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.addressBar, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
            ...
            style: { ...styles6.iconButton, ...!canGoBack ? styles6.iconButtonDisabled : {} },
            children: "\u2190"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            ...
            onClick: () => moveInHistory(1),
            style: { ...styles6.iconButton, ...!canGoForward ? styles6.iconButtonDisabled : {} },
            children: "\u2192"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: openPreview, style: styles6.secondaryButton, children: "\u6253\u5F00" }),
        workspaceMode === "presentation" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: () => setShowPresentationBrief(true), style: styles6.createPresentationButton, children: "\u65B0\u5EFA\u6F14\u793A\u6587\u7A3F" }) : null,
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "button",
          {
            type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.modeGroup, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "button",
            {
              type: "button",
              ...
              style: { ...styles6.modeButton, ...selectionMode === "element" ? styles6.modeButtonActive : {} },
              children: "\u9009\u62E9\u5143\u7D20"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "button",
            {
              ...
              style: { ...styles6.modeButton, ...selectionMode === "area" ? styles6.areaModeButtonActive : {} },
              children: "\u6846\u9009\u533A\u57DF"
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", "aria-label": "\u5173\u95ED\u9875\u9762\u8BC4\u6CE8", title: "\u5173\u95ED", onClick: onClose, style: styles6.closeButton, children: "\xD7" })
      ] }),
      !hasSession ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: styles6.sessionHint, children: "\u5148\u53D1\u4E00\u6761\u6D88\u606F\u540E\uFF0C\u53F3\u4FA7\u201C\u53D1\u9001\u7ED9 Agent\u201D\u624D\u53EF\u63D0\u4EA4\u3002" }) : null
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.studioToolbarRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        BreakpointToolbar,
        {
          value: viewport,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { style: styles6.scopeField, children: [
        "\u54CD\u5E94\u8303\u56F4",
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { value: responsiveScope, onChange: (event) => setResponsiveScope(event.target.value), style: styles6.scopeSelect, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "current-breakpoint", children: "\u4EC5\u5F53\u524D\u65AD\u70B9" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "current-and-smaller", children: "\u5F53\u524D\u53CA\u66F4\u5C0F\u65AD\u70B9" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("option", { value: "all-breakpoints", children: "\u5168\u90E8\u65AD\u70B9" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { ...styles6.workspace, ...workspaceMode === "presentation" ? styles6.presentationWorkspace : {} }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: styles6.previewShell, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { ...styles6.deviceFrame, width: viewport.width, height: viewport.height }, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
        "iframe",
        {
          ref: iframeRef,
          title: "\u524D\u7AEF\u9875\u9762\u8BC4\u6CE8\u9884\u89C8",
          ...
          style: { ...styles6.iframe, width: viewport.width, height: viewport.height },
          onLoad: () => {
            postResponsiveContext();
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("aside", { style: styles6.sidebar, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.sidebarHeader, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: "\u8BC4\u6CE8\u961F\u5217" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.count, children: queued.length })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.sidebarHeaderActions, children: [
            !isFeedbackDraftEmpty({ selection, areaOperation, comment, queued }) ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", onClick: clearDraft, style: styles6.clearDraftButton, children: "\u6E05\u7A7A\u8349\u7A3F" }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...styles6.statePill, ...selectionMode !== null ? styles6.statePillActive : {} }, children: selectionMode === "element" ? "\u5143\u7D20\u9009\u62E9" : selectionMode === "area" ? "\u533A\u57DF\u6846\u9009" : "\u6D4F\u89C8\u6A21\u5F0F" })
          ] })
        ] }),
        activeProgress !== null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          ProgressTimeline,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.sidebarScroller, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.scrollArea, children: [
            queued.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.commentCard, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.cardIndex, children: [
                "#",
                index + 1
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.cardBody, children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { style: styles6.cardTitle, children: cardTitle(item) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.cardComment, children: item.comment })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                "button",
                {
                  ...
                  style: styles6.removeButton,
                  children: "\xD7"
                }
              )
            ] }, `${item.kind === "area" ? `area-${item.rect.x}-${item.rect.y}` : item.selector}-${index}`)),
            queued.length === 0 && selection === null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.emptyQueue, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.emptyIcon, children: "\u2301" }),
          ...
          selection !== null ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.composer, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.selectedMeta, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { ...styles6.tag, ...selection.kind === "area" ? styles6.areaTag : {} }, children: selection.kind === "area" ? "AREA" : selection.tagName }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("code", { style: styles6.selector, children: selectionCode(selection) })
            ] }),
            selectionSummary(selection) ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { style: styles6.selectedText, children: selectionSummary(selection) }) : null,
            selection.sourceHints !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.sourceHint, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "\u6E90\u7801\u5B9A\u4F4D" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("strong", { children: selection.sourceHints.file ?? selection.sourceHints.component ?? "\u5019\u9009\u7EC4\u4EF6" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("em", { children: [
                Math.round(selection.sourceHints.confidence * 100),
                "% \u8BC1\u636E\u7F6E\u4FE1\u5EA6"
              ] })
            ] }) : null,
            selection.kind === "area" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.operationField, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.operationLabel, children: "\u65B0\u589E\u5185\u5BB9\u5982\u4F55\u5F71\u54CD\u5F53\u524D\u5E03\u5C40" }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { role: "group", "aria-label": "\u533A\u57DF\u4FEE\u6539\u65B9\u5F0F", style: styles6.operationGroup, children: AREA_OPERATIONS.map((option) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                "button",
                {
                  type: "button",
                  ...
                  style: {
                    ...styles6.operationButton,
                    ...areaOperation === option.value ? styles6.operationButtonActive : {}
                  },
                  children: option.label
                },
                option.value
              )) }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.operationHelp, children: AREA_OPERATIONS.find((option) => option.value === areaOperation)?.description })
            ] }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              GuidanceEditor,
              {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.composerActions, children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
                "button",
                {
                  type: "button",
                  ...
                  style: styles6.ghostButton,
                  children: "\u53D6\u6D88"
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", disabled: comment.trim().length === 0, onClick: queueCurrent, style: styles6.primaryButton, children: "\u52A0\u5165\u961F\u5217" })
            ] })
          ] }) : null,
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: styles6.footer, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: styles6.status, children: status }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              "button",
              {
                type: "button",
    ...
    showHistory ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      VisualHistoryPanel,
      {
        records: history,
    ...
    showStudio ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      StudioDrawer,
      {
        busy: studioBusy,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
      "button",
      {
        ...
        style: styles6.launcherButton,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { "aria-hidden": "true", style: styles6.launcherIcon, children: "\u25A3" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: "PageCraft" })
        ]
      }
    ),
    open ? (0, import_react_dom.createPortal)(
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { role: "dialog", "aria-modal": "true", "aria-label": "PageCraft", style: styles6.launcherOverlay, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: styles6.launcherPanel, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
